...
/**
 * This is the ASet class as described in the
 * INF101 course of Telecom Paristech.
 * The ASet contains vertexes for which the shortest path
 * has already been found (vertexes already examined by the dijkstra algorithm).
 */
