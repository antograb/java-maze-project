...
/**
 * This is the Graph class as described in
 * the INF101 course of Telecom Paristech.
 * Graph contains the representation of all the vertexes,
 * with the information on which vertex(es)
 * a vertex is linked to and at what cost.
 */
public interface GraphInterface {

	/**
	 * Gets the number of <code>VertexInterface</code> in the graph.
	 * @return An integer giving the number of
	 * 	   <code>VertexInterface</code> in the graph.
	 */
	 ...
	 * @param end
	 * 	The vertex from which we must see the cost
	 *	of the link to <code>start</code>.
	 * @return An integer giving the cost of the link between
	 *	   the given <code>VertexInterface</code>.
	 */
